    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          ...
          <p class="productContent"><b>Carod</b> </p>

          <a href="../html3/carod/upw2.jsp">
            <p class="wzy"> Upright Piano White</p>
          </a><br>

          <a href="../html3/carod/gpw2.jsp">
            <p class="wzy"> Grand Piano White</p>
          </a><br>

          <a href="../html3/carod/upb2.jsp">
            <p class="wzy"> Upright Piano Black</p>
          </a><br>

          <a href="../html3/carod/gpb2.jsp">
            <p class="wzy"> Grand Piano Black</p>
          </a><br>

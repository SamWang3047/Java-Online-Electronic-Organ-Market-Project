    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/yamaha.jpg"></div>
		  <p class="productContent"><b>Yamaha</b> </p>

          <a href="../html3/yamaha/2w2.jsp">
            <p class="wzy"> NP2 White</p>
          </a><br>
          <a href="../html3/yamaha/8w2.jsp">
            <p class="wzy"> NP8 White</p>
          </a><br>
          <a href="../html3/yamaha/2b2.jsp">
            <p class="wzy"> NP2 Black</p>
          </a><br>
          <a href="../html3/yamaha/8b2.jsp">
            <p class="wzy"> NP8 Black</p>
          </a>

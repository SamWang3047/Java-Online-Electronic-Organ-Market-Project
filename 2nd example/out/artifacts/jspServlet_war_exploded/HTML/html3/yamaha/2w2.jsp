...
<%session.setAttribute("itemID",10031);%>
<%session.setAttribute("iPrice",3698.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/yamaha3.jpg"></div>
          <p class="price"><b>NP2 White</b> </p>
          <p class="price"><b>¥3698</b> </p>

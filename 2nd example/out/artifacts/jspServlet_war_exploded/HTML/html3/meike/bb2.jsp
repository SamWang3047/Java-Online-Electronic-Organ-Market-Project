...
<%session.setAttribute("itemID",10022);%>
<%session.setAttribute("iPrice",3017.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/meike1.jpg"></div>
          <p class="price"><b>Beginner Piano Black</b> </p>
          <p class="price"><b>¥3017.0</b> </p>

...
<%session.setAttribute("itemID", 10020);%>
<%session.setAttribute("iPrice", 3015.5);%>
<div id="mainWrapper">
    <header>
        ...
        <div id="headerLinks">
            <form method="get" action="/GetAllItem" style="">
                ...
                <input align="center" type="SUBMIT" value="Cart" onclick="window.location.href = 'Cart_new.jsp'"
                       style="background-color:white;border: none;color:rgba(146,146,146,1.00);cursor:pointer;">
            </form>
        </div>
    </header>
    <div id="content">
        <section class="sidebar">
            ...
            <div id="menubar">
                <nav class="menu">
                    <h2><a href="../../html1/main_manu2.jsp"><!-- Title for menuset 1 --><font color="#000000">MAIN
                        MANU</font></a></h2>
                    <hr>
                    <ul>
        ...
        <section class="mainContent">
            <div class="productRow"><!-- Each product row contains info of 3 elements -->
                <article class="productInfo"><!-- Each individual product description -->
                    <div><img alt="sample" src="../../file/livid1.png"></div>
                    <p class="price"><b>Livid White</b></p>
                    <p class="price"><b>¥3015.5</b></p>

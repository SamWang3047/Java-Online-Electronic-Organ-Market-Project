...
<%session.setAttribute("itemID",10025);%>
<%session.setAttribute("iPrice",4651.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/shengjie1.jpg"></div>
          <p class="price"><b>80bass White</b> </p>
          <p class="price"><b>¥4651</b> </p>

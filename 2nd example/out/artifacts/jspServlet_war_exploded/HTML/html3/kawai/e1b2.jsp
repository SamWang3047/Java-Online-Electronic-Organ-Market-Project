...
<%session.setAttribute("itemID",10016);%>
<%session.setAttribute("iPrice",3011.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/kawai2.jpg"></div>
          <p class="price"><b>ES1 Black</b> </p>
          <p class="price"><b>¥3011</b> </p>

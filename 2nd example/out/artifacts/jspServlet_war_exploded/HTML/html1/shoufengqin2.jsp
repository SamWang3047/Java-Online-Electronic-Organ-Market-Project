            ...
            <div id="menubar">
                <nav class="menu">
                    ...
                    <ul>
                        ...
                        <li><a href="shoufengqin2.jsp" title="Link"><b>Accordion</b></a></li>
        ...
        <section class="mainContent">
            <div class="productRow"><!-- Each product row contains info of 3 elements -->
                <article class="productInfo"><!-- Each individual product description -->
                    ...
                    <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/yingwu2.jsp'">
                </article>
                <article class="productInfo"><!-- Each individual product description -->

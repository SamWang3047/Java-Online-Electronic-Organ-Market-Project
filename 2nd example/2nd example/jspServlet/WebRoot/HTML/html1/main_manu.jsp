...
<div id="mainWrapper">
  <header> 
    ...
    <div id="headerLinks"><a href="../../User_Login.jsp" title="Login/Register">Login/Register</a></div>
  </header>
  <section id="offer">
  ...
  <div id="content">
    <section class="sidebar"> 
      ...
      <div id="menubar">
        <nav class="menu">
          <h2><a href="main_manu.jsp"><!-- Title for menuset 1 --><font color="#000000">MAIN MANU</font></a> </h2>
          <hr>
          <ul>
            <!-- List of links under menuset 1 -->
            <li><a href="dianziqin.jsp" title="Link">Keyboard</a></li>
            <li><a href="shoufengqin.jsp" title="Link">Accordion</a></li>
            <li><a href="gangqin.jsp" title="Link">Piano</a></li>
          </ul>
        </nav>
      </div>
    </section>
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          ...
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/yamaha.jsp'">
        </article>
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/huaxing.jpg" height="180"></div>
          <p class="price">Huaxing</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/huaxing.jsp'">
        </article>
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="../file/Or1.jpg" height="180"></div>
          <p class="price">Cake Organ</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/kamier.jsp'">
        </article>
      </div>
      <div class="productRow"> 
        ...
        <article class="productInfo"> <!-- Each individual product description -->
          ...
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/kawai.jsp'">
        </article>
        <article class="productInfo"> <!-- Each individual product description -->
          <div><img alt="sample" src="../file/livid.jpg" height="180"></div>
          <p class="price">Livid</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/livid.jsp'">
        </article>
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/meike.jpg" height="180"></div>
          <p class="price">Meike</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/meike.jsp'">
        </article>
      </div>
      <div class="productRow">
        <article class="productInfo"> <!-- Each individual product description -->
          ...
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/shengjie.jsp'">
        </article>
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/shoujuan.jpg" height="180"></div>
          <p class="price">Shoujuan</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/shoujuan.jsp'">
        </article>
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/carod.jpg" height="180"></div>
          <p class="price">Carod</p>
          <input type="button" name="button" value="Buy" class="buyButton" onclick="location.href='../html2/carod.jsp'">
        </article>

        ...
        <section class="mainContent">
            <div class="productRow"><!-- Each product row contains info of 3 elements -->
                <article class="productInfo"><!-- Each individual product description -->
                    <div><img alt="sample" src="../file/kawai.jpg"></div>
                    <p class="productContent"><b>Kawai</b> </p>
                    <a href="../html3/kawai/e1w2.jsp">
                        <p class="wzy"> ES1 White</p>
                    </a><br>
                    <a href="../html3/kawai/e2w2.jsp">
                        <p class="wzy"> ES2 White</p>
                    </a>
                    <a href="../html3/kawai/e1b2.jsp"><br>
                        <p class="wzy"> ES1 Black</p>
                    </a><br>
                    <a href="../html3/kawai/e2b2.jsp">
                        <p class="wzy"> ES2 Black</p>
                    </a><br>

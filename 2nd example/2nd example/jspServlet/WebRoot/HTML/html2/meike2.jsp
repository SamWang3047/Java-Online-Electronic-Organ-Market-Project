    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/meike.jpg"></div>
		  <p class="productContent"><b>Meike</b> </p>
          <a href="../html3/meike/bw2.jsp">
            <p class="wzy">Beginner piano white</p>
          </a><br>
          <a href="../html3/meike/aw2.jsp">
            <p class="wzy"> Adult piano white</p>
          </a><br>
          <a href="../html3/meike/bb2.jsp">
            <p class="wzy"> Beginner piano black</p>
          </a><br>
          <a href="../html3/meike/ab2.jsp">
            <p class="wzy"> Adult piano black</p>
          </a>

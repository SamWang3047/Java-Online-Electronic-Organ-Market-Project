    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
		  ...
		  <p class="productContent"><b>Cake Organ</b> </p>
          <a href="../html3/kamier/Or12.jsp">
            <p class="wzy"> Model 1</p>
          </a><br>
          <a href="../html3/kamier/OrX2.jsp">
            <p class="wzy"> Model X(with the remote control)</p>
          </a>

    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
		  ...
		  <a href="../html3/yingwu/6w.jsp">
              <p class="wzy"> 60Bass White</p>
		  </a><br>
		<a href="../html3/yingwu/8w.jsp">
            <p class="wzy"> 80Bass White</p>
		  </a><br>
		  <a href="../html3/yingwu/1w.jsp">
              <p class="wzy"> 120Bass White</p>
		  </a><br>
		<a href="../html3/yingwu/6b.jsp">
            <p class="wzy"> 60Bass Black</p>
		  </a><br><a href="../html3/yingwu/8b.jsp">
                <p class="wzy"> 80Bass Black</p>
            </a><br>
		<a href="../html3/yingwu/1b.jsp">

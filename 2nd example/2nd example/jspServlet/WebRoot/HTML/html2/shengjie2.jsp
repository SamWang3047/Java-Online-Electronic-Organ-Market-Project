    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../file/shengjie.jpg"></div>
		  <p class="productContent"><b>Shengjie</b> </p>
          <a href="../html3/shengjie/8w2.jsp">
            <p class="wzy"> 80Bass White</p>
          </a><br>
          <a href="../html3/shengjie/9w2.jsp">
            <p class="wzy"> 96Bass White</p>
          </a>
          <a href="../html3/shengjie/8b2.jsp"><br>
            <p class="wzy"> 80Bass Black</p>
          </a><br>
          <a href="../html3/shengjie/9b2.jsp">
            <p class="wzy"> 96Bass Black</p>
          </a><br>

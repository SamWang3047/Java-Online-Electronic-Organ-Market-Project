      ...
      <div id="menubar">
        <nav class="menu">
          ...
          <ul>
            ...
            <li><a href="../../html1/dianziqin.jsp" title="Link">dianziqin</a></li>
            <li><a href="../../html1/shoufengqin.jsp" title="Link">shoufengqin</a></li>
            <li><a href="../../html1/gangqin.jsp" title="Link">gangqin</a></li>
          </ul>
        </nav>
      </div>
    </section>
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/meike2.jpg"></div>
          <p class="price"><b>Beginner piano white</b> </p>
          <p class="price"><b>¥3016</b> </p>

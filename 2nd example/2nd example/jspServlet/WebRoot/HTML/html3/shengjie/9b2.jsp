...
<%session.setAttribute("itemID",10027);%>
<%session.setAttribute("iPrice",2354.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/shengjie2.jpg"></div>
          <p class="price"><b>96Bass Black</b> </p>
          <p class="price"><b>¥2354</b> </p>

...
<%session.setAttribute("itemID",10035);%>
<%session.setAttribute("iPrice",19999.0);%>
<div id="mainWrapper">
    <header>
        ...
        <section class="mainContent">
            <div class="productRow"><!-- Each product row contains info of 3 elements -->
                <article class="productInfo"><!-- Each individual product description -->
                    <div><img alt="sample" src="../../file/Or2.jpg"></div>
                    This is an electronic organ used for the beginners. We designed it to be environmental friendly by using used boxes and papers.
                    By using the organ, you can not only learn to play music and record your achievements, but also have fun exploring different modules, like Trill Mode, Tremolo Mode, Multitone Mode, IR control Mode, Ultrasonic Mode and so on.
                    <p class="price"><b>Cake Organ Model X(with the remote control)</b> </p>
                    <p class="price"><b>¥19999</b> </p>

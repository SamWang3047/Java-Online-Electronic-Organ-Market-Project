...
<%session.setAttribute("itemID",10032);%>
<%session.setAttribute("iPrice",2541.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/yamaha1.jpg"></div>
          <p class="price"><b>NP2 Black</b> </p>
          <p class="price"><b>¥2541</b> </p>

...
<%session.setAttribute("itemID",10007);%>
<%session.setAttribute("iPrice",3002.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <div id="headerLinks">
      <form method="get" action="/GetAllItem" style="">
        Welcome! user:<%=userID%><a href="../../Log_Out_Success.jsp" title="Click to Log out">Log out &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          ...
          <p class="price"><b>Upright Piano Black</b> </p>
          <p class="price"><b>¥3002</b> </p>

...
<%session.setAttribute("itemID",10029);%>
<%session.setAttribute("iPrice",4521.0);%>
<div id="mainWrapper">
  <header> 
    ...
    <section class="mainContent">
      <div class="productRow"><!-- Each product row contains info of 3 elements -->
        <article class="productInfo"><!-- Each individual product description -->
          <div><img alt="sample" src="../../file/shoujuan1.jpg"></div>
          <p class="price"><b>ShouJuan White</b> </p>
          <p class="price"><b>¥4521</b> </p>

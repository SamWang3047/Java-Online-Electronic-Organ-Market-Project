...
<div class="wrap">
        <div class="container">
            <h1 style="color: white; margin: 0; text-align: center">Purchase Succeed!</h1>
            <form>
                <p class="change_link" style="text-align: center">
                   
    <span class="text">Please click</span>
    <a href="HTML/html1/main_manu2.jsp" class="to_Signup">here</a>
    <span class="text">to go back to main menu</span>
...
<%--    </form></li>--%>
<%--    <span class="text">to check your order</span>--%>
